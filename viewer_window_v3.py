...
def _load_image_for_display(filepath: Path, is_raw_folder: bool) -> np.ndarray:
    ...
    # 16-bit -> 8-bit. Auto-detect non-aligned 12-bit data (old captures
    # where values are 0-4095 in a 16-bit container) and align before
    # downshifting so the image isn't displayed as black.
